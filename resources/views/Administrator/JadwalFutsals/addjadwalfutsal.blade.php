...
<div class="pagetitle">
    <h1>Tambah Data Jadwal Futsal</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item">Jadwal</li>
        <li class="breadcrumb-item"><a href="{{ route('JadwalFutsal') }}"></a>Data Jadwal Futsal</li>
        <li class="breadcrumb-item active">Tambah Data Jadwal Futsal</li>
      </ol>
    </nav>
</div><!-- End Page Title -->
...
<div class="col-lg-12">
    ...
    <div class="card">
      <div class="card-body"><br>
        <form class="row g-3" action="{{ route('insertJadwalFutsal') }}" method="POST">
        @csrf
        <div class="col-12">
              ...
              <select id="id_gor" class="form-control" name="id_gor" required>
                <option value="">-- Select --</option>
                  @foreach ($data_gor as $row)
                    <option value="{{ $row->id }}">{{ $row->nama_gor }}</option>
                  @endforeach
              </select>
          </div>
