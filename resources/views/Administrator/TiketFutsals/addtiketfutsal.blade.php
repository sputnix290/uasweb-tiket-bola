...
<div class="pagetitle">
    <h1>Tambah Data Tiket Futsal</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item">Tiket</li>
        <li class="breadcrumb-item"><a href="{{ route('TiketFutsal') }}"></a>Data Tiket Futsal</li>
        <li class="breadcrumb-item active">Tambah Data Tiket Futsal</li>
      </ol>
    </nav>
</div><!-- End Page Title -->
...
<div class="col-lg-12">
    ...
    <div class="card">
      <div class="card-body"><br>
        <form class="row g-3" action="{{ route('insertTiketFutsal') }}" method="POST">
        @csrf
        <div class="col-12">
